...
import {
  ...
  AFTERMATH_LAYOUT, AFTERMATH_BOTTOM_LAYOUT,
  FLIP_LAYOUT,
  MUTATE_LAYOUT,
  PROTO_LAYOUT,
  LEVELER_LAYOUT,
...
const TEMPLATE_CONFIGS: Record<TemplateName, { layout: Record<string, any>; w: number; h: number; linkedLayout?: Record<string, any> }> = {
  ...
  aftermath:          { layout: AFTERMATH_LAYOUT, w: PW_W, h: PW_H, linkedLayout: AFTERMATH_BOTTOM_LAYOUT },
...
export function resolveTemplate(card: CardData): TemplateName {
  ...
  if (card.linkType === 'omen') return 'omen';
